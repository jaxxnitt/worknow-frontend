    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] animate-fadeIn">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-10 w-full max-w-md border border-white/20">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-gray-800 to-black rounded-2xl shadow-lg mb-4 animate-bounce-slow">
          ...
          <p className="text-gray-500 mt-2">
            Sign in to continue to WorkNow
          </p>
        </div>
        ...
        <div className={`transition-all duration-300 ${isLoading ? 'opacity-0 h-0 overflow-hidden' : 'opacity-100'}`}>
          {!googleReady && (
